...
<body>
	...
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath}/FoodServlet" method="get">
			...
			<input type="text" name="dname" title="请输入菜系名称" valve="${param.dname }">
		...
		<table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<tbody id="TableData">
				<c:forEach var="temp" items="${requestScope.tableList.data}">
					<tr>
						<td>${pageScope.temp.TYPEID}</td>
						<td>${pageScope.temp.TYPENAME}</td>
						<td>
							<a href="${pageContext.request.contextPath}/detail/updateCuisine.jsp?tid=${pageScope.temp.TYPEID}&tname=${pageScope.temp.TYPENAME}" class="FunctionButton">更新</a> 
							<a href="javascript:confirmDelete(${pageScope.temp.TYPEID })" class="FunctionButton">删除</a>
						</td>
					</tr>
				</c:forEach>
				<tr><td colspan="3">
