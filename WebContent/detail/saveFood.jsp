            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
							<td width="80px">菜系</td>
							<td>
							<jsp:useBean id="myList" class="cn.et.model.foodType.MyFoodDesk" ></jsp:useBean>
                            <select name="typeId" style="width:80px">
		   					<c:forEach var="temp" items="${pageScope.myList.allFoodType}">
		   						<option value="${pageScope.temp.TYPEID}" 
		   						>${pageScope.temp.TYPENAME}</option>
		   					</c:forEach>	
                            </select>
